...
namespace DB
{
    ...
    struct Frame
    {
        ...
        int dirty_bit;      // Indica si una pagina ha sido modificada
    ...
    Page* Buffer::FetchPageImpl(int page_id) 
    {
        ...
        else
        {
            ...
            int target;
            if(!free_list_.empty())     //Si existen espacios disponibles
            {
    ...
    Page *Buffer::NewPageImpl(int *page_id) 
    {
        ...
        {
            int free_frame = free_list_.front();        // Indice de frame libre
    ...
    bool Buffer::DeletePageImpl(int page_id) {
        ...
        else
        {
            ...
            else
            {
                ...
                buffer_pool[target].dirty_bit = false;  // pagina no modificada 
